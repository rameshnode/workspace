...
public class Response {
    ...
    @XmlElementRef(name = "mimeType", namespace = "http://webservice.unitymedia.de/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> mimeType;
    protected Integer result;
    @XmlElementRef(name = "resultMsg", namespace = "http://webservice.unitymedia.de/xsd", type = JAXBElement.class, required = false)
